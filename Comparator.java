...
//      System.out.println(list);
	     ...
	     Collections.sort(list, new Comparator<Student>() {  // anonymous object (comparator => anonymous class)
	     ...
	     Collections.sort(list, (o1, o2) -> o1.name.compareTo(o2.name)); //lambda java 8
